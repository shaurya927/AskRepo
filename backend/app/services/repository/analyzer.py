"""Repository analysis orchestrator — coordinates cloning, scanning, and statistics."""
...
class RepositoryAnalyzer:
    ...
    Steps:
      ...
      2. Scan files
      3. Compute statistics and detect frameworks
      4. Persist RepositoryFile + RepositoryStats records
      5. Update job/repo status
    ...
    async def analyze(
        ...
        repo_dir = target_dir  # Will be updated if ZIP extraction creates a subdir
